...
{
    public class StatisticsXrayOldService
    {
        ...
        public StatisticsXrayOldService(Config config, Action<ServerSpeedItem> updateFunc)
        {
            _config = config;
        ...
        private async void Run()
        {
            while (!_exitFlag)
            {
                ...
                try
                {
                    if (_config.RunningCoreType != ECoreType.XrayOld)
                    {
                        continue;
                    }
